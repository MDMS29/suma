...
const BLink = ({ children, url, tipo }) => {
    ...
    const estilos = {
        ...
        VERIFICADA: "px-4 p-2 mx-2 rounded-md text-green-600 border-2 border-green-600 hover:bg-green-600 hover:text-white transition duration-300 ease-in-out font-semibold",
