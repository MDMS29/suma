...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      <div className="h-full flex border-r shadow-sm bg-white  max-sm:absolute z-10">
        <div
          className={` ${
            open
            ...
            {authModulos.map((modulo, index) => (
              <div key={index}>
                <li
                  ...
                  className={`flex font-semibold rounded-md p-2 mx-2 cursor-pointer hover:bg-primaryYellow text-sm justify-center gap-x-4 ${
      ...
      <div className="m-2">
        <button
          className=" z-90 bottom-10 right-8 bg-primaryYellow w-10 h-10 rounded-lg drop-shadow-lg flex justify-center items-center  text-4xl hover:bg-yellow-500 duration-300"
