...
export const UnidadesMedida_Icono = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="35"
    height="35"
...
export const Perfil_Icono = <i className="pi pi-user" style={{ fontSize: "2rem" }}></i>

export const Filter_Icono = <i className="pi pi-filter"></i>;

export const Rol_Icono = <img src={RolIcono} alt="Logo Rol" width={40} />;

export const NoReq_Icono = <img src={NoReqIcono} alt="Logo Rol" width={200} />;

export const Proceso_Icono = (
  <img src={ProcesoIcono} alt="Logo Proceso" width={40} />
);

export const Producto_Icono = (
  <img src={ProductoIcono} alt="Logo Producto" width={40} />
);
...
export const PDF_Icono = (
  <i className="pi pi-file-pdf mx-2 font-medium text-red-800"></i>
);

export const Lupa_Icono = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="22"
    height="22"
...
export const Cancelar_Filtro_Icon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
