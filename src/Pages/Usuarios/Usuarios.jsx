...
const Usuarios = () => {
  ...
  const { dataUsuarios, setUsuarioState, buscarUsuario, setPerfilesEdit,
    setPermisosEdit } = useUsuarios();
  ...
  return (
    <div className="w-5/6">
      <Toast ref={toast} />
      {modalVisible && <ModalAgregarUsuarios visible={modalVisible} onClose={toggleModal} />}
