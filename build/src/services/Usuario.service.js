...
class UsuarioService {
    ...
    Obtener_Usuarios(estado) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const respuesta = yield this._Query_Usuario.Obtener_Usuarios(estado); //INVOCAR FUNCION PARA OBTENER LOS USUARIOS
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (Usuario_Editado != usuario) {
                    const usuarioDuplicado = yield this._Query_Usuario.Buscar_Usuario_Correo(Usuario_Editado, ''); //INVOCAR FUNCION PARA BUSCAR EL USUARIO 
                ...
                if (Correo_Editado != correo) {
                    const correoDuplicado = yield this._Query_Usuario.Buscar_Usuario_Correo('', Correo_Editado); //INVOCAR FUNCION PARA BUSCAR EL USUARIO POR EL CORREO
