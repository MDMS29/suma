...
exports._cambiar_estado_producto = exports._editar_producto_empresa = exports._FA_obtener_productos_filtro = exports._buscar_producto_id = exports._buscar_producto_referencia = exports._buscar_producto_nombre = exports._insertar_producto_empresa = exports._obtener_productos_empresa = void 0;
exports._obtener_productos_empresa = `
    SELECT 
...
`;
exports._insertar_producto_empresa = `
    INSERT INTO 
...
`;
exports._buscar_producto_nombre = `
    SELECT 
...
`;
exports._buscar_producto_referencia = `
    SELECT 
        tp.id_producto, tp.id_empresa, tp.id_familia, tp.id_marca, tp.id_tipo_producto,
        tp.referencia, tp.id_unidad, tp.descripcion, 
        tp.precio_costo, tp.precio_venta, tp.foto, tp.ficha, tp.inventariable,  
...
exports._buscar_producto_id = `
    ...
    WHERE
        tp.id_producto = $1;
`;
exports._FA_obtener_productos_filtro = 'public.obtener_productos_filtro';
exports._editar_producto_empresa = `
    UPDATE 
        public.tbl_productos
    SET 
    ...
    WHERE 
        id_producto=$1;
`;
exports._cambiar_estado_producto = `
    UPDATE 
        public.tbl_productos
    SET 
        id_estado=$2
