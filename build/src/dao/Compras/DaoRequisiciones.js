...
exports._buscar_requisicion_consecutivo = `
    ...
    WHERE
        tr.requisicion = $1
`;
exports._insertar_requisicion_enc = `
    INSERT INTO 
...
`;
exports._insertar_requisicion_det = `
    INSERT INTO 
...
exports._buscar_requisicion_id = ` 
    ...
    WHERE
        tr.id_requisicion = $1
`;
exports._editar_requisicion_enc = `
    UPDATE 
        public.tbl_requisiciones
    SET 
    ...
    WHERE 
        id_requisicion=$1;       
`;
exports._editar_requisicion_det = `
    UPDATE 
        public.tbl_requisicion_detalle
    SET 
    ...
    WHERE 
        id_detalle=$1;
`;
exports._cambiar_estado_requisicion = `
    UPDATE 
        public.tbl_requisiciones
    SET 
        id_estado=$2
